...
class Osintgram:
    ...
    def __printTargetBanner__(self):
        print("\nLogged as ")
        print(self.api.username)
        print(". Target: ")
        print(str(self.target))
        print(" [" + str(self.target_id) + "]")
        if self.is_private:
    ...
    def get_total_comments(self):
        ...
        print("Searching for target total comments...\n")
        ...
        print(str(comments_counter))
        print(" comments in " + str(posts) + " posts\n")
    ...
    def get_followers(self):
        ...
        print("Searching for target followers...\n")
    ...
    def get_followings(self):
        ...
        print("Searching for target followings...\n")
    ...
    def get_hashtags(self):
        ...
        print("Searching for target hashtags...\n")
    ...
    def get_total_likes(self):
        ...
        print("Searching for target total likes...\n")
        ...
        print(str(like_counter))
        print(" likes in " + str(posts) + " posts\n")
    ...
    def get_people_who_commented(self):
        ...
        print("Searching for users who commented...\n")
    ...
    def get_user_photo(self):
        ...
        if self.cli_mode:
            ...
            print("How many photos you want to download (default all): ")
            user_input = input()

        try:
            if user_input == "":
                print("Downloading all photos available...\n")
            else:
                limit = int(user_input)
                print("Downloading " + user_input + " photos...\n")
    ...
    def get_user_stories(self):
        ...
        print("Searching for target stories...\n")
        ...
        if counter > 0:
            print(str(counter) + " target stories saved in output folder\n")
        else:
            print("Sorry! No results found :-(\n")
    ...
    def get_fwersemail(self):
        ...
        try:
            ...
            print("Searching for emails of target followers... this can take a few minutes\n")
    ...
    def get_fwingsnumber(self):
        ...
        try:
            ...
            print("Searching for phone numbers of users followed by target... this can take a few minutes\n")
